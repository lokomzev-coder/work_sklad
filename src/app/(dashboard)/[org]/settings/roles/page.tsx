    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Пользовательские роли сужают видимость заказов и заказов поставщику сотрудника до только
          назначенных на него («личный кабинет»). Назначьте роль сотруднику на карточке сотрудника, в
          разделе «Доступ в систему». Роль не расширяет права базовой роли (администратор/менеджер/
          сотрудник) — только сужает видимость.
        </p>
      </div>
      <CustomRolesManager
        orgSlug={org}
