 ...
 * reachable from the kassa interface (CASHIER role never sees `/settings`
 * at all, see (dashboard)/[org]/layout.tsx's redirect gate). Mirror of
 * (floor)/[org]/floor/profile/page.tsx — the DefaultsForm's storeId picker
 * doubles as the CASHIER's required retail-store assignment (see
 * (kassa)/[org]/kassa/page.tsx, where defaultStoreId is enforced). */
export default async function KassaProfilePage({
  params,
}: {
